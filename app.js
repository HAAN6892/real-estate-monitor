...
function updateRentTable(equity,budget){
  ...
  document.getElementById('rentPropertyBadge').textContent=mapBoundsFilter&&mapBounds?'지도 영역 내 '+ti+'건':ti+'/'+RENT_PROPERTIES.length+'개 표시';
